    ...
    <main className="border-b border-[#19371E]/8">
      {isPreview ? (
        <div className="border-b border-amber-200 bg-amber-50 px-4 py-3 text-center text-sm text-amber-950">
          <strong>Draft preview</strong> — this product is not published. Only people with this link
          can view it.
        </div>
      ) : null}
            ...
            <div className="mt-10">
              {isPreview ? (
                <p className="rounded-xl border border-amber-200/80 bg-amber-50/60 px-4 py-3 text-sm text-amber-950">
                  Checkout is disabled in draft preview. Publish the product to sell on the
                  storefront.
                </p>
              ) : (
                <>
                  ...
                  <p className="mt-4 text-xs leading-relaxed text-[#19371E]/50">
                    You will be redirected to a secure checkout page to enter payment and shipping
                    details.
                  </p>
                </>
              )}
